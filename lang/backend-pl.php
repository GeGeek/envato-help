...
*/
    ...
    define('DOPBSP_CALENDARS_NO_ADD_HELP', "Kliknij w wybranym miejscu aby edytować.");
    ...
    define('DOPBSP_CALENDAR_EDIT_ADMINISTRATOR_HELP', "Wybierz dni i godziny aby edytować. Kliknij ikonę 'ołówka' aby edytować ustawienia kalendarza. Jeśli klikniesz ikonę 'mail' zobaczysz aktualne rezerwacje. Kliknij ikonę 'użytkownicy' aby ustawić uprawienia dostępu do kalendarzy. W dokumentacji znajdziesz więcej informacji.");
    ...
    define('DOPBSP_ADD_CALENDAR_SUBMIT', "Dodaj kalendarz");
    define('DOPBSP_ADD_CALENDAR_SUBMITED', "Dodawanie kalendarz ...");
    define('DOPBSP_ADD_CALENDAR_SUCCESS', "Kalendarz został dodany, gratulacje.");
    ...
    // Delete Calendar
    define('DOPBSP_DELETE_CALENDAR_CONFIRMATION', "Czy na pewno chcesz usunąć kalendarz?");
    define('DOPBSP_DELETE_CALENDAR_SUBMIT', "Usuń kalendarz");
    define('DOPBSP_DELETE_CALENDAR_SUBMITED', "Usuwanie kalendarza ...");
    define('DOPBSP_DELETE_CALENDAR_SUCCESS', "Usunięcie kalendarza zakończone sukcesem.");
    ...
    define('DOPBSP_DETAILS_FROM_HOURS_INFO', "Domyślnie: Aktywne. Wybierz opcję jeśli godziny są aktywowane, jesli chcesz aktualizować szcegóły dnia lub wyłącz jeśli chcesz samodzielnie wprowadzać szczegóły dnia.");
    
    define('DOPBSP_HOURS_ENABLED_INFO', "Domyślnie: Nieaktywne. Aktywuj godziny dla tego kalendarza.");
    define('DOPBSP_HOURS_INFO_ENABLED_INFO', "Domyślnie: Aktywne. Pokazuj informację o godzinach jeśli podświetlone są dni w kalendarzu.");
    ...
    define('DOPBSP_ADD_BOOKING_FORM_SUBMIT', "Dodaj formularz");
    define('DOPBSP_ADD_BOOKING_FORM_SUBMITED', "Dodawanie formularza ...");
    define('DOPBSP_ADD_BOOKING_FORM_SUCCESS', "Formularz został dodany pomyślnie.");
    ...
    // Delete Booking Form
    define('DOPBSP_DELETE_BOOKING_FORM_CONFIRMATION', "Czy jesteś pewnien, że chcesz usunąć formularz?");
    define('DOPBSP_DELETE_BOOKING_FORM_SUBMIT', "Usuń formularz");
    define('DOPBSP_DELETE_BOOKING_FORM_SUBMITED', "Usuwanie formularza ...");
    define('DOPBSP_DELETE_BOOKING_FORM_SUCCESS', "Usuwanie formularza zakończona pomyślnie.");
    ...
    // General Settings
    define('DOPBSP_TITLE_SETTINGS', "Ustawienia");
    
    define('DOPBSP_USERS_PERMISSIONS', "Uprawienia użytkowników");
    define('DOPBSP_USERS_CUSTOM_POSTS_TYPE_PERMISSIONS', "Ustawienia własnych wpisów");
    define('DOPBSP_USERS_SHOW', "pokaż użytkowników");
    define('DOPBSP_USERS_HIDE', "ukryj użytkowników");
    define('DOPBSP_USERS_NO_ADMINISTRATORS', "Brak administratorów!");
    define('DOPBSP_USERS_NO_AUTHORS', "Brak autorów!");
    define('DOPBSP_USERS_NO_CONTRIBUTORS', "There are no contributors!");
    define('DOPBSP_USERS_NO_EDITORS', "Brak edytorów!");
    define('DOPBSP_USERS_NO_SUBSCRIBERS', "Brak subskrybentów!");
    define('DOPBSP_USERS_ADMINISTRATORS', "Administratorzy");
    define('DOPSBP_USERS_ADMINISTRATORS_BULK_PERMISSIONS_INFO', "Zaznacz administratorów aby zobaczyć wszystkie kalendarze i uprawnienia.");
    ...
    define('DOPBSP_USERS_SUBSCRIBERS', "Odbiorcy");
    ...
    define('DOPBSP_USERS_PERMISSIONS_HELP', "Wybierz użytkowników, którzy będą używać kalendarza.");
    define('DOPBSP_USERS_CUSTOM_POSTS_TYPE_PERMISSIONS_HELP', "Wybierz użytkowników, którzy będą używać kalendarza w artykułach.");
    ...
    define('DOPBSP_CUSTOM_POSTS_TYPE_BOOKING_SYSTEM', "System rezerwacji");
    
    // Widget    
    define('DOPBSP_WIDGET_TITLE', "System rezerwacji");
    define('DOPBSP_WIDGET_DESCRIPTION', "Zaznacz opcję jeśli chcesz pokazać w widzetach i kalendarzach.");
    define('DOPBSP_WIDGET_LABEL_TITLE', "Nazwa:");
    define('DOPBSP_WIDGET_LABEL_SELECTION', "Wybierz działanie");
    define('DOPBSP_WIDGET_SELECTION_CALENDAR', "Dodaj kalendarz");
    define('DOPBSP_WIDGET_SELECTION_SIDEBAR', "Dodaj pasek boczny kalendarza");
    define('DOPBSP_WIDGET_LABEL_ID', "Wybierz kalendarz:");
    define('DOPBSP_WIDGET_NO_CALENDARS', "Brak kalendarzy.");
    define('DOPBSP_WIDGET_LABEL_LANGUAGE', "Wybierz język:");
