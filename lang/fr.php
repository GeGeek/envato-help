...
*/
    ...
    define('DOPBSP_CALENDARS_NO_ADD_HELP', "Cliquez sur un élément de calendrier pour ouvrir la zone d'édition.");
    ...
    define('DOPBSP_CALENDAR_EDIT_ADMINISTRATOR_HELP', "Sélectionnez les jours et les heures à éditer. Cliquez sur l'icône 'stylo' pour éditer les paramètres du calendrier. Cliquez sur l'icône 'e-mail' pour voir si vous avez des réservations. Cliquez sur l'icône 'utilisateurs' pour permettre l'accès à ce calendrier à d'autres utilisateurs. Lisez la documentation pour plus d'informations.");
    ...
    define('DOPBSP_ADD_CALENDAR_SUBMIT', "Ajouter un calendrier");
    define('DOPBSP_ADD_CALENDAR_SUBMITED', "Ajout du calendrier ...");
    define('DOPBSP_ADD_CALENDAR_SUCCESS', "Vous avez ajouté un nouveau calendrier avec succès.");
    ...
    // Delete Calendar
    define('DOPBSP_DELETE_CALENDAR_CONFIRMATION', "Etes-vous sûr de vouloir supprimer ce calendrier ?");
    define('DOPBSP_DELETE_CALENDAR_SUBMIT', "Supprimer ce calendrier");
    define('DOPBSP_DELETE_CALENDAR_SUBMITED', "Suppression du calendrier ...");
    define('DOPBSP_DELETE_CALENDAR_SUCCESS', "Vous avez supprimé ce calendrier avec succès.");
    ...
    define('DOPBSP_DETAILS_FROM_HOURS_INFO', "Valeur par défaut: Activé. Cochez cette option, quand les heures sont activées, si vous voulez que le détails des jours soit mis à jour (calculé) depuis le détails des heures ou désactivez cela si vous voulez avoir le contrôle complet des détails des jours.");
    
    define('DOPBSP_HOURS_ENABLED_INFO', "Valeur par défaut: Désactivé. Activer les heures dans le calendrier.");
    define('DOPBSP_HOURS_INFO_ENABLED_INFO', "Valeur par défaut: Activé. Afficher les informations des heures quand vous survolez un jour dans le calendrier.");
    ...
    define('DOPBSP_ADD_BOOKING_FORM_SUBMIT', "Ajouter un formulaire");
    define('DOPBSP_ADD_BOOKING_FORM_SUBMITED', "Ajout du formulaire ...");
    define('DOPBSP_ADD_BOOKING_FORM_SUCCESS', "Vous avez ajouté le formulaire avec succès.");
    ...
    // Delete Booking Form
    define('DOPBSP_DELETE_BOOKING_FORM_CONFIRMATION', "Etes-vous sûr de vouloir supprimer ce formulaire?");
    define('DOPBSP_DELETE_BOOKING_FORM_SUBMIT', "Supprimer le formulaire");
    define('DOPBSP_DELETE_BOOKING_FORM_SUBMITED', "Suppression du formulaire ...");
    define('DOPBSP_DELETE_BOOKING_FORM_SUCCESS', "Vous avez supprimé le formulaire avec succès.");
    ...
    // General Settings
    define('DOPBSP_TITLE_SETTINGS', "Paramètres");
    
    define('DOPBSP_USERS_PERMISSIONS', "Permissions des utilisateurs");
    define('DOPBSP_USERS_CUSTOM_POSTS_TYPE_PERMISSIONS', "Permissions des postes personnalisés");
    define('DOPBSP_USERS_SHOW', "montrer les utilisateurs");
    define('DOPBSP_USERS_HIDE', "cacher les utilisateurs");
    define('DOPBSP_USERS_NO_ADMINISTRATORS', "Il n'y a aucun administrateur!");
    define('DOPBSP_USERS_NO_AUTHORS', "Il n'y a aucun auteur!");
    define('DOPBSP_USERS_NO_CONTRIBUTORS', "Il n'y a aucun contributeur!");
    define('DOPBSP_USERS_NO_EDITORS', "Il n'y a aucun éditeur!");
    define('DOPBSP_USERS_NO_SUBSCRIBERS', "Il n'y a aucun abonné!");
    define('DOPBSP_USERS_ADMINISTRATORS', "Administrateurs");
    define('DOPSBP_USERS_ADMINISTRATORS_BULK_PERMISSIONS_INFO', "Vérifier les administrateurs à voir tous les calendriers de tous les utilisateurs et/ou les ajouter/éditer individuellement.");
    define('DOPSBP_USERS_ADMINISTRATORS_BULK_CUSTOM_POSTS_TYPE_PERMISSIONS_INFO', "Vérifier les administrateurs à utiliser les postes personnalisés du Système de réservation Pro.");
    define('DOPBSP_USERS_AUTHORS', "Auteurs");
    define('DOPSBP_USERS_AUTHORS_BULK_PERMISSIONS_INFO', "Vérifiez les auteurs à visualiser le plugin et individuellement modifier uniquement leurs propres calendriers.");
    define('DOPSBP_USERS_AUTHORS_BULK_CUSTOM_POSTS_TYPE_PERMISSIONS_INFO', "Vérifiez les auteurs à utiliser les postes personnalisés du Système de réservation Pro.");
    define('DOPBSP_USERS_CONTRIBUTORS', "Contributors");
    define('DOPBSP_USERS_CONTRIBUTORS_BULK_PERMISSIONS_INFO', "Vérifiez les contributeurs à visualiser le plugin et individuellement modifier uniquement leurs propres calendriers.");
    define('DOPBSP_USERS_CONTRIBUTORS_BULK_CUSTOM_POSTS_TYPE_PERMISSIONS_INFO', "Vérifiez les contributeurs à utiliser les postes personnalisés du Système de réservation Pro.");
    define('DOPBSP_USERS_EDITORS', "Editors");
    define('DOPSBP_USERS_EDITORS_BULK_PERMISSIONS_INFO', "Vérifiez les éditeurs à visualiser le plugin et individuellement modifier uniquement leurs propres calendriers.");
    define('DOPSBP_USERS_EDITORS_BULK_CUSTOM_POSTS_TYPE_PERMISSIONS_INFO', "Vérifier les éditeurs à utiliser les postes personnalisés du Système de réservation Pro.");
    define('DOPBSP_USERS_SUBSCRIBERS', "Abonnés");
    define('DOPBSP_USERS_SUBSCRIBERS_BULK_PERMISSIONS_INFO', "Vérifiez les abonnés à visualiser le plugin et individuellement modifier uniquement leurs propres calendriers.");
    define('DOPBSP_USERS_SUBSCRIBERS_BULK_CUSTOM_POSTS_TYPE_PERMISSIONS_INFO', "Vérifier les abonnés à utiliser les postes personnalisés du Système de réservation Pro.");
    define('DOPBSP_USERS_PERMISSIONS_HELP', "Vérifier les utilisateurs qui vont vérifier ce calendrier.");
    define('DOPBSP_USERS_CUSTOM_POSTS_TYPE_PERMISSIONS_HELP', "Vérifiez les utilisateurs qui vont utiliser ce calendrier à un poste personnalisé.");
    
    // Custom Post Type
    define('DOPBSP_CUSTOM_POSTS_TYPE', 'Postes personnalisés du Système de réservation Pro');
    define('DOPBSP_CUSTOM_POSTS_TYPE_ADD_NEW_ITEM_ALL_ITEMS', 'Postes');
    define('DOPBSP_CUSTOM_POSTS_TYPE_ADD_NEW_ITEM', 'Ajouter un nouveau poste personnalisé du Système de réservation Pro');
    define('DOPBSP_CUSTOM_POSTS_TYPE_EDIT_ITEM', 'Editer un poste personnalisé du Système de réservation Pro');
    define('DOPBSP_CUSTOM_POSTS_TYPE_BOOKING_SYSTEM', "Système de réservation Pro");
    
    // Widget    
    define('DOPBSP_WIDGET_TITLE', "Système de réservation Pro");
    define('DOPBSP_WIDGET_DESCRIPTION', "Sélectionnez l'option que vous souhaitez voir apparaître dans le widget et le(s) ID(s) du(des) calendrier(s).");
    define('DOPBSP_WIDGET_LABEL_TITLE', "Titre:");
    define('DOPBSP_WIDGET_LABEL_SELECTION', "Sélectionnez l'action");
    define('DOPBSP_WIDGET_SELECTION_CALENDAR', "Ajouter un calendrier");
    define('DOPBSP_WIDGET_SELECTION_SIDEBAR', "Ajouter un panneau latéral de calendrier");
    define('DOPBSP_WIDGET_LABEL_ID', "Sélectionnez l'ID du calendrier:");
    define('DOPBSP_WIDGET_NO_CALENDARS', "Aucun calendrier.");
    define('DOPBSP_WIDGET_LABEL_LANGUAGE', "Sélectionnez la langue:");
