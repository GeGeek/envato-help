...
<html>
    <head>
        <title>Law Experts - Online Booking PSD Template<?php echo $subtitle; ?></title>

        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <meta name="description" content="Law Experts is a clean and complete booking PSD template ideal for booking portals and more." />
    ...
    <body>
        <div id="wrapper">
            <div id="header">
                <h1>Law Experts - Online Booking PSD Template</h1>
            </div>  